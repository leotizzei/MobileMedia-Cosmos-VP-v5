...
public class MainUIMidlet extends MIDlet implements IMobileResources {
	...
	br.unicamp.ic.sed.mobilemedia.excep_sms_vp.impl.IManager eh_sms;
	...
	public void startApp() throws MIDletStateChangeException {
		...
		eh_sms = br.unicamp.ic.sed.mobilemedia.excep_sms_vp.impl.ComponentFactory.createInstance();
		/*********************************************************************************************/
		...
		eh_sms.setRequiredInterface("IExceptionHandler", exceptionHandler.getProvidedInterface("IExceptionHandler"));
