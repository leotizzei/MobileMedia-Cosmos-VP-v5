...
public aspect XPIPhotoController {
	...
	public pointcut showImage( String imageName ):
		execution(void br.unicamp.ic.sed.mobilemedia.photo.impl.PhotoController.showImage(String))
		&& args( imageName );
	...
	public pointcut callShowImage():
		call(void br.unicamp.ic.sed.mobilemedia.photo.impl.PhotoController.showImage(String));
